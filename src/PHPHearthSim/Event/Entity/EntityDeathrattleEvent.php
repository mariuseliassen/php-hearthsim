...
/**
 * Event when entities deathrattle is triggered
 *
 * @class EntityDeathrattleEvent
 */
class EntityDeathrattleEvent extends EntityEvent {

    /**
     * Construct new EntityDeathrattleEvent
     *
